...
FA2 = sp.io.import_script_from_url("file:tokens/fa2.py")
...
class TokenDropFA12(sp.Contract):
    ...
    def claim(self, params):
        ...
        c_token = sp.contract(
            sp.TList(
                sp.TRecord(from_=sp.TAddress, txs=Types.FA2_TRANSFER_TXS_TYPE).layout(
                    ("from_", "txs"),
                )
            ),
...
if __name__ == "__main__":
    ...
    def test():
        ...
        scenario.verify(token.data.ledger[Addresses.ALICE].balance == 100)
        ...
        scenario.verify(token.data.ledger[Addresses.BOB].balance == 200)
    ...
    sp.add_compilation_target("token_drop_fa2", TokenDropFA12())
